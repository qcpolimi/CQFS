...
class DataReader(object):
    ...
    #
    #     self.loaded_global_mapper_dict = dataIO.load_data(file_name ="dataset_global_mappers")
    #
    #     self.loaded_URM_dict = dataIO.load_data(file_name ="dataset_URM")
    #
    #     if len(self.get_loaded_ICM_names()) > 0:
    #         self.loaded_ICM_dict = dataIO.load_data(file_name ="dataset_ICM")
    #
    #         self.loaded_ICM_mapper_dict = dataIO.load_data(file_name ="dataset_ICM_mappers")
