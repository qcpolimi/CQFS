...
from recsys.Base.BaseCBFRecommender import BaseItemCBFRecommender
from recsys.Base.BaseSimilarityMatrixRecommender import BaseItemSimilarityMatrixRecommender
from recsys.Base.Incremental_Training_Early_Stopping import Incremental_Training_Early_Stopping
from recsys.Base.Recommender_utils import check_matrix
from recsys.Base.IR_feature_weighting import okapi_BM_25, TF_IDF
...
class FBSM_Rating_Cython(BaseItemCBFRecommender, BaseItemSimilarityMatrixRecommender, Incremental_Training_Early_Stopping):
    ...
    def runCompilationScript(self):
        ...
        # python compile_script.py FBSM_Rating_Cython_SGD.pyx build_ext --inplace

        # Command to generate html report
        # cython -a FBSM_Rating_Cython_SGD.pyx
